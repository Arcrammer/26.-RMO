...
(function() {
  (function($) {
    return $(function() {
      ...
      $('.panel:first-of-type a').click(function(event) {
        var desiredFormat, downloadListButton, linkClicked;
        ...
        return $('#filesize-indication').text(downloads[desiredFormat]['size']);
      });
      $('.panel a').click(function(event) {
        $(event.target).closest('ul').children('li').children('a').removeClass('chosen');
        return $(event.target).addClass('chosen');
      });
      return null;
    });
  })(jQuery);
